...
sys.path.append('C:/FM_e-services-main/pv_performance_ratio')
os.chdir('C:/FM_e-services-main/pv_performance_ratio')
import pandas as pd
import numpy as np
import json
import pvlib
...
energy_output_meter=pd.read_csv('data/generation_meter_readings.csv')
