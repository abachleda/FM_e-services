...
sys.path.append('C:/KTP_e-services-master/pv_performalnce_ratio')
os.chdir('C:/KTP_e-services-master/pv_performalnce_ratio')
import pandas as pd
import numpy as np
import json
import pvlib
...
if not os.path.exists('outputs/'+name):
    os.makedirs('outputs/'+name, mode=0o777)
